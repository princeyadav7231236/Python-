...
# my_list = ["1", "6", "87", "43", "99", 45, 23]    # This is the sample list

for item in my_list:
    if int(item) < 10:
        print(f"Palindrome of {item} is {item}")
    elif item == str(item)[::-1] and int(item) > 10:   # If the item is equal to the Palindrome of the item then it will print the same output
