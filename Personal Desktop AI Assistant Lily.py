...
def sendEmail(to, content):
    ...
    server.ehlo()
    server.starttls()
    server.login("your_Email_here", "your_Gmail_password_here")
...
if __name__ == '__main__':
    ...
    while True:
        ...
        if "wikipedia" in query:
            ...
            json_of_news = request.get("https://newsapi.org/v2/top-headlines?country=in&category=science&apiKey=95a2058faa4e49ddb1391a8fcc2de3eb")
        ...
        #     time.sleep(5)
            ...
            try:
                ...
                print("Sorry boss, can you please repeat your question ?")
                speak("Sorry boss, can you please repeat your question ?")
            ...
            try:
                ...
                if x["cod"] != "404":
                    ...
                    print("Temperature in Degree Celsius unit is " + str(current_temperature - 273.15) + "\n Humidity in percentage is " + str(
                        current_humidity) + "\n Description " + str(weather_description))
                    speak(
                        "Temperature in Degree Celsius unit is " + str( current_temperature - 273.15) + "\n Humidity in percentage is " + str(
                            current_humidity) + "\n Description " + str(weather_description))
